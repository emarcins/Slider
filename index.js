class Slider {
    ...
    initializeSlider() {
        ...
        this.slideCaption = document.createElement('figcaption'); /* figcaption reprezentuje podpis lub legendę dla zawartości selektora <figure>/ figcaption is a signature of picture */
        this.addCaption();
    ...
    changeSlide(index) {
        if(index === -1 || index === this.slideArrayLength) 
            return; /* czyli zwróć NIC, po prostu nie wykonuj zadnych akcji, wszystko poza tym zakresem zwraca NIC (nie nie robi) / it doesn't make any action, it returns nothing */
